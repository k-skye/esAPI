...
##### URL：
```
https://service-lbinlxgu-1252070599.gz.apigw.tencentcs.com/release/getBindData
```
##### 参数：
| 名称      |  说明  |
| :--------| :-----|
...
```
{
    ...
    "data":{
            ...
            "2020-2021-1":[
                {
                    ...
                    "day":"2020-12-07",
                    "time":"19:00-21:00",
                    "time_str":"第15周周1(2020-12-07) 19:00-21:00",
                    "location":"A3-103",
                    "sit_id":8,
                    "sch_place":"分校区"
                },
        ...
        "info":{
            ...
            "class_name":"2018软件工程4班",
            "faculty":"计算机工程学院",
            "specialty":"软件工程",
            "hometown":"广东省佛山市禅城区",
            "enrol_time":"2018-09-01",
            "education_level":"本科",
            "eductional_systme":"4",
            "id_card":"440603200003073011"
        }
    }
}
```